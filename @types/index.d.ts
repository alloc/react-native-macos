...
export interface NativeMouseEvent {
    ...
    /**
     * The node id of the element receiving the mouse event
     */
    target: string;

    /**
     * A time identifier for the mouse, useful for velocity calculation
     */
    timestamp: number;
}
...
export class Image extends ImageBase {
    static useScale: (rootTag: number) => number;
